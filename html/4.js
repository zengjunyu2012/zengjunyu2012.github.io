...
<cr-dialog id="dialog" show-on-attach="">
  ...
  <div slot="body">
    <div id="buttons">
      ...
      <cr-button id="emailButton" title="电子邮件" on-click="onEmailClick_">
      </cr-button>
    </div>
    <cr-input readonly="" label="涂鸦链接" id="url" value="[[url.url]]">
      <cr-icon-button id="copyButton" slot="suffix" title="复制链接" on-click="onCopyClick_">
      </cr-icon-button>
    </cr-input>
  </div>
  ...
  <div id="doodle" title="[[doodle_.description]]">
    <div id="imageDoodle" hidden="[[!imageDoodle_]]" tabindex$="[[imageDoodleTabIndex_]]" on-click="onImageClick_" on-keydown="onImageKeydown_">
      <div id="imageContainer">
        ...
        <cr-button id="shareButton" title="分享涂鸦" on-click="onShareButtonClick_" hidden="[[!imageDoodle_.shareButton]]">
  ...
  <dom-if if="[[lazyRender_]]" on-dom-change="onLazyRendered_">
    <template>
      ...
      <div id="customizeButtonContainer">
        <cr-button id="customizeButton" on-click="onCustomizeClick_" title="自定义此页">
